...
void PilFflonkSteps::step3prev_first(AltBn128::Engine &E, PilFflonkStepsParams &params, uint64_t i) {
     ...
     AltBn128::FrElement tmp_30 = E.fr.add(params.cm3_n[3 + i*4], params.challenges[2]);
     AltBn128::FrElement tmp_31 = E.fr.mul(params.tmpExp_n[0 + ((i + 1)%256)*7], params.challenges[3]);
     AltBn128::FrElement tmp_32 = E.fr.add(params.tmpExp_n[0 + i*7], tmp_31);
     AltBn128::FrElement tmp_33 = E.fr.add(params.constValues[0], params.challenges[3]);
     AltBn128::FrElement tmp_34 = E.fr.mul(params.challenges[2], tmp_33);
     AltBn128::FrElement tmp_35 = E.fr.add(tmp_32, tmp_34);
     AltBn128::FrElement tmp_36 = E.fr.mul(tmp_30, tmp_35);
     AltBn128::FrElement tmp_37 = E.fr.add(params.constValues[0], params.challenges[3]);
     params.tmpExp_n[1 + i*7] = E.fr.mul(tmp_36, tmp_37);
     AltBn128::FrElement tmp_38 = E.fr.mul(params.cm2_n[1 + i*2], params.challenges[3]);
     ...
     AltBn128::FrElement tmp_43 = E.fr.mul(params.cm2_n[0 + ((i + 1)%256)*2], params.challenges[3]);
     AltBn128::FrElement tmp_44 = E.fr.add(params.cm2_n[1 + i*2], tmp_43);
     AltBn128::FrElement tmp_45 = E.fr.add(params.constValues[0], params.challenges[3]);
     AltBn128::FrElement tmp_46 = E.fr.mul(params.challenges[2], tmp_45);
     ...
     params.tmpExp_n[3 + i*7] = E.fr.add(tmp_89, params.challenges[3]);
     ...
     params.tmpExp_n[4 + i*7] = E.fr.add(tmp_93, params.challenges[3]);
     AltBn128::FrElement tmp_94 = params.cm1_n[2 + i*15];
     AltBn128::FrElement tmp_56 = E.fr.mul(params.challenges[3], params.x_n[i]);
     AltBn128::FrElement tmp_57 = E.fr.add(tmp_94, tmp_56);
     AltBn128::FrElement tmp_95 = E.fr.add(tmp_57, params.challenges[2]);
     AltBn128::FrElement tmp_96 = params.cm1_n[3 + i*15];
     AltBn128::FrElement tmp_58 = E.fr.mul(params.challenges[3], params.constValues[1]);
     AltBn128::FrElement tmp_59 = E.fr.mul(tmp_58, params.x_n[i]);
     AltBn128::FrElement tmp_60 = E.fr.add(tmp_96, tmp_59);
     AltBn128::FrElement tmp_61 = E.fr.add(tmp_60, params.challenges[2]);
     AltBn128::FrElement tmp_97 = E.fr.mul(tmp_95, tmp_61);
     AltBn128::FrElement tmp_98 = params.cm1_n[4 + i*15];
     AltBn128::FrElement tmp_62 = E.fr.mul(params.challenges[3], params.constValues[2]);
     AltBn128::FrElement tmp_63 = E.fr.mul(tmp_62, params.x_n[i]);
     AltBn128::FrElement tmp_64 = E.fr.add(tmp_98, tmp_63);
     AltBn128::FrElement tmp_65 = E.fr.add(tmp_64, params.challenges[2]);
     params.tmpExp_n[5 + i*7] = E.fr.mul(tmp_97, tmp_65);
     AltBn128::FrElement tmp_99 = params.const_n[3 + i * 9];
     AltBn128::FrElement tmp_66 = E.fr.mul(params.challenges[3], tmp_99);
     AltBn128::FrElement tmp_67 = E.fr.add(tmp_94, tmp_66);
     AltBn128::FrElement tmp_100 = E.fr.add(tmp_67, params.challenges[2]);
     AltBn128::FrElement tmp_101 = params.const_n[4 + i * 9];
     AltBn128::FrElement tmp_68 = E.fr.mul(params.challenges[3], tmp_101);
     AltBn128::FrElement tmp_69 = E.fr.add(tmp_96, tmp_68);
     AltBn128::FrElement tmp_70 = E.fr.add(tmp_69, params.challenges[2]);
     AltBn128::FrElement tmp_102 = E.fr.mul(tmp_100, tmp_70);
     AltBn128::FrElement tmp_103 = params.const_n[5 + i * 9];
     AltBn128::FrElement tmp_71 = E.fr.mul(params.challenges[3], tmp_103);
     AltBn128::FrElement tmp_72 = E.fr.add(tmp_98, tmp_71);
     AltBn128::FrElement tmp_73 = E.fr.add(tmp_72, params.challenges[2]);

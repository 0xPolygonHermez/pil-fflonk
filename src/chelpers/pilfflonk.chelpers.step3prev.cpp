...
void PilFflonkSteps::step3prev_first(AltBn128::Engine &E, StepsParams &params, uint64_t i) {
     ...
     params.tmpExp_n[0 + i*4] = E.fr.add(tmp_17, params.challenges[1]);
     ...
     AltBn128::FrElement tmp_22 = E.fr.sub(tmp_21, params.tmpExp_n[0 + i*4]);
     AltBn128::FrElement tmp_23 = E.fr.mul(tmp_22, tmp_81);
     params.cm3_n[3 + i*7] = E.fr.add(tmp_23, params.tmpExp_n[0 + i*4]);
     ...
     params.tmpExp_n[0 + ((i + 1)%256)*4] = E.fr.add(tmp_29, params.challenges[1]);
     AltBn128::FrElement tmp_30 = E.fr.add(params.cm3_n[3 + i*7], params.challenges[3]);
     AltBn128::FrElement tmp_31 = E.fr.mul(params.tmpExp_n[0 + ((i + 1)%256)*4], params.challenges[2]);
     AltBn128::FrElement tmp_32 = E.fr.add(params.tmpExp_n[0 + i*4], tmp_31);
     ...
     AltBn128::FrElement tmp_37 = E.fr.add(E.fr.set(1), params.challenges[2]);
     params.cm3_n[4 + i*7] = E.fr.mul(tmp_36, tmp_37);
     ...
     AltBn128::FrElement tmp_45 = E.fr.add(E.fr.set(1), params.challenges[2]);
     AltBn128::FrElement tmp_46 = E.fr.mul(params.challenges[3], tmp_45);
     AltBn128::FrElement tmp_47 = E.fr.add(tmp_44, tmp_46);
     params.tmpExp_n[1 + i*4] = E.fr.mul(tmp_42, tmp_47);
     ...
     params.tmpExp_n[2 + i*4] = E.fr.add(tmp_89, params.challenges[2]);
     ...
     params.tmpExp_n[3 + i*4] = E.fr.add(tmp_93, params.challenges[2]);
     ...
     AltBn128::FrElement tmp_58 = E.fr.mul(params.challenges[2], params.constValues[0]);
     ...
     AltBn128::FrElement tmp_62 = E.fr.mul(params.challenges[2], params.constValues[1]);
     ...
     params.cm3_n[5 + i*7] = E.fr.mul(tmp_97, tmp_65);
     ...
     params.cm3_n[6 + i*7] = E.fr.mul(tmp_102, tmp_73);
}

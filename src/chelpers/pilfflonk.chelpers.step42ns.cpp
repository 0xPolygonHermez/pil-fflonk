...
AltBn128::FrElement PilFflonkSteps::step42ns_first(AltBn128::Engine &E, StepsParams &params, uint64_t i) {
     ...
     AltBn128::FrElement tmp_8 = E.fr.mul(params.challenges[2], E.fr.set(5266228460530200451425464971825753823072228272503274930591399474110020095489));
...
void PilFflonkSteps::step42ns_i(AltBn128::Engine &E, StepsParams &params, uint64_t i) {
     ...
     AltBn128::FrElement tmp_14 = E.fr.mul(params.challenges[4], tmp_15);
     AltBn128::FrElement tmp_25 = E.fr.add(tmp_14, tmp_24);
     E.fr.copy((AltBn128::FrElement &)(params.q_2ns[i]), tmp_25);
}

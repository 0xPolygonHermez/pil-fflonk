...
void PilFflonkSteps::step42ns_first(AltBn128::Engine &E, StepsParams &params, uint64_t i) {
     AltBn128::FrElement tmp_0 = E.fr.sub(params.pols[193 + ((i + 4)%256)*2], params.pols[192 + i*2]);
     AltBn128::FrElement tmp_1 = E.fr.sub(E.fr.set(1), params.pConstPols2ns->getElement(1,i));
     AltBn128::FrElement tmp_2 = E.fr.mul(tmp_0, tmp_1);
     AltBn128::FrElement tmp_25 = E.fr.sub(tmp_2, E.fr.set(0));
     AltBn128::FrElement tmp_3 = E.fr.sub(params.pols[192 + ((i + 4)%256)*2], params.pols[448 + i*1]);
     AltBn128::FrElement tmp_4 = E.fr.sub(E.fr.set(1), params.pConstPols2ns->getElement(1,i));
     AltBn128::FrElement tmp_5 = E.fr.mul(tmp_3, tmp_4);
     AltBn128::FrElement tmp_26 = E.fr.sub(tmp_5, E.fr.set(0));
     AltBn128::FrElement tmp_6 = E.fr.sub(params.pols[193 + i*2], params.publicInputs[0]);
     AltBn128::FrElement tmp_7 = E.fr.mul(params.pConstPols2ns->getElement(0,i), tmp_6);
     AltBn128::FrElement tmp_27 = E.fr.sub(tmp_7, E.fr.set(0));
     AltBn128::FrElement tmp_8 = E.fr.sub(params.pols[192 + i*2], params.publicInputs[1]);
     AltBn128::FrElement tmp_9 = E.fr.mul(params.pConstPols2ns->getElement(0,i), tmp_8);
     AltBn128::FrElement tmp_28 = E.fr.sub(tmp_9, E.fr.set(0));
     AltBn128::FrElement tmp_10 = E.fr.sub(params.pols[192 + i*2], params.publicInputs[2]);
     AltBn128::FrElement tmp_11 = E.fr.mul(params.pConstPols2ns->getElement(1,i), tmp_10);
     ...
     AltBn128::FrElement tmp_21 = E.fr.mul(params.pols[192 + i*2], params.pols[192 + i*2]);
     AltBn128::FrElement tmp_22 = E.fr.mul(params.pols[193 + i*2], params.pols[193 + i*2]);
     AltBn128::FrElement tmp_23 = E.fr.add(tmp_21, tmp_22);
     AltBn128::FrElement tmp_24 = E.fr.sub(tmp_23, params.pols[448 + i*1]);
     AltBn128::FrElement tmp_30 = E.fr.add(tmp_20, tmp_24);
     E.fr.copy((AltBn128::FrElement &)(params.q_2ns[i]), tmp_30);
}

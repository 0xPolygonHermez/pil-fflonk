...
void PilFflonkSteps::step2prev_first(AltBn128::Engine &E, StepsParams &params, uint64_t i) {
     ...
     AltBn128::FrElement tmp_14 = params.const_n[7 + i * 9];
     AltBn128::FrElement tmp_15 = params.const_n[8 + i * 9];
     AltBn128::FrElement tmp_16 = params.cm1_n[14 + i*15];
     AltBn128::FrElement tmp_17 = params.const_n[6 + i * 9];
     AltBn128::FrElement tmp_0 = E.fr.mul(params.challenges[0], tmp_14);
     AltBn128::FrElement tmp_1 = E.fr.add(tmp_0, tmp_15);
     AltBn128::FrElement tmp_2 = E.fr.mul(params.challenges[0], tmp_1);
     AltBn128::FrElement tmp_3 = E.fr.add(tmp_2, tmp_16);
     AltBn128::FrElement tmp_4 = E.fr.sub(tmp_3, params.challenges[1]);
     AltBn128::FrElement tmp_5 = E.fr.mul(tmp_4, tmp_17);
     params.cm3_n[5 + i*15] = E.fr.add(tmp_5, params.challenges[1]);
     AltBn128::FrElement tmp_18 = params.cm1_n[11 + i*15];
     ...
     AltBn128::FrElement tmp_9 = E.fr.add(tmp_8, params.cm3_n[4 + i*15]);
     AltBn128::FrElement tmp_10 = E.fr.sub(tmp_9, params.cm3_n[5 + i*15]);
     AltBn128::FrElement tmp_11 = E.fr.mul(tmp_10, tmp_18);
     params.cm3_n[6 + i*15] = E.fr.add(tmp_11, params.cm3_n[5 + i*15]);
}
